...
interface Warehouse { id: string; sellerId: string; name: string; cityCode: number; cityName: string; address: string; isDefault: boolean; }
...
export default function DashboardPage({ setPage }: DashboardPageProps) {
  ...
  const [whCityCode, setWhCityCode] = useState(0);
  ...
  const handleAddWarehouse = async () => {
    ...
    try {
      ...
      setShowWhForm(false);
      setWhName(""); setWhAddress(""); setWhCityCode(0); setWhCityName(""); setWhCityQuery(""); setWhCitySuggestions([]);
